...
- Top navigation is the primary app navigation for the current your organization MVP shell.
...
- Theme tokens must be resolved from organization branding settings when available, with the your organization default palette only as fallback.
