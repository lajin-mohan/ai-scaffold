...
description: Use for Engyne bug fixes, failed tests, runtime errors, API issues, UI defects, Docker/local environment failures, database inconsistencies, auth/redirect/CORS issues, and production incidents where the fix must be reproduced, root-caused, corrected, tested, and verified with evidence.
---

# Systematic Debugging Skill

Use this skill whenever investigating or fixing an Engyne defect.
