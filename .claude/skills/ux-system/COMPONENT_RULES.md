...
- Top navigation is the primary app navigation for the current MVP shell.
...
- Theme tokens must be resolved from organization branding settings when available, with the default palette only as fallback.
