...
These are Techversant default fallback tokens. Runtime UI must resolve theme values from organization branding settings when available, then fall back to these defaults. Do not hardcode these hex values in pages, components, charts, or feature code.

| Token | Hex | Usage |
|---|---|---|
| Techversant Green | `#00C875` | Primary actions, focused states, selected states, success |
